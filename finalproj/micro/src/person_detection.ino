...
void setup() {
  ...
  TF_LITE_REPORT_ERROR(error_reporter, "JHDBG: About to AddAveragePool2D");
  ...
  TF_LITE_REPORT_ERROR(error_reporter, "input->dims[0]: %d", input->dims->data[0]);
  TF_LITE_REPORT_ERROR(error_reporter, "input->dims[1]: %d", input->dims->data[1]);
  TF_LITE_REPORT_ERROR(error_reporter, "input->dims[2]: %d", input->dims->data[2]);
  TF_LITE_REPORT_ERROR(error_reporter, "input->dims[3]: %d", input->dims->data[3]);
  TF_LITE_REPORT_ERROR(error_reporter, "Input Type is: %d", input->type);

  TF_LITE_REPORT_ERROR(error_reporter, "Finished Setup.");
}
...
void loop() {
  ...
  TF_LITE_REPORT_ERROR(error_reporter, "Got output.");
